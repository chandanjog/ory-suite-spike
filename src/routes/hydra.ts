    ...
    (createHelpers) => async (req, res, next) => {
        ...
        return hydraClient
            ...
            .then(({data: body}) => {
                ...
                req.headers['host'] = kratosBrowserUrl
...
export const createHydraGetConsentRoute: RouteCreator =
    (createHelpers) => async (req, res, next) => {
    ...
    hydraClient
        ...
        .then(({ data: body }) => {
            ...
            res.render('consent', {
                // csrfToken: req.csrfToken(), // TODO: Check if needed?
                challenge: challenge,
...
export const registerHydraLoginRoute: RouteRegistrator = (
    app,
    createHelpers = defaultConfig
) => {
    app.get('/hydra/login', createHydraLoginRoute(createHelpers))
}

export const registerHydraGetConsentRoute: RouteRegistrator = (
    app,
    createHelpers = defaultConfig
) => {
